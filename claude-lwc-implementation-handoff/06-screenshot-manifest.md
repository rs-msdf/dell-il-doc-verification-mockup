...
| `screenshots/09-applicant-income-not-uploaded.png` | Applicant Income benefits statement in `Not uploaded` state. | No uploaded files; no-preview state; Verify requires acceptance comment. |
