...
## Main static flow: group overview and Applicant ID workspace
...
| --- | --- | --- |
| Complete group | Parent 1 ID; Applicant Disability Status | Group overview marks complete and sample data has all documents and fields complete. |
| Incomplete group | Applicant ID; Parent 2 ID; Applicant Income | Group overview marks incomplete with blocker count. |
