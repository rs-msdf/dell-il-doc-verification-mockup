...
- Represent the required verification groups:
  - Applicant ID.
  - Parent 1 ID.
  - Parent 2 ID.
  - Applicant Income.
  ...
  - Parent 1 Estrangement.
  - Parent 2 Estrangement.
  - Parent 1 Death Certificate.
  - Parent 2 Death Certificate.
  - Address during last school year.
  - Last school score.
...
- Allow reviewers to move between all verification tasks while preserving visible progress.
...
- Stateful sample application data across all verification tasks and major edge cases.
